...
public class MaintenanceInfoDetailAdapter extends BaseQuickAdapter<MaintenanceInfo, QuickViewHolder> {
    ...
    public MaintenanceInfoDetailAdapter() {
        this(Mode.HOME);
    }

    public MaintenanceInfoDetailAdapter(Mode mode) {
        this.mode = mode == null ? Mode.HOME : mode;
        this.itemLayoutResId = R.layout.item_maintenance_setting_detail;
    }
