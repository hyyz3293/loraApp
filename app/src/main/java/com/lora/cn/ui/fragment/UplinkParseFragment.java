...
public class UplinkParseFragment extends Fragment {
    ...
    private java.util.List<Item> buildItemsFromFrame(LoRaFrameParser.ParsedFrame frame) {
        ...
        list.add(new Item("终端版本-YY", frame.termVerYY >= 0 ? String.format(java.util.Locale.getDefault(), "%02d", frame.termVerYY) : "无效"));
        ...
        list.add(new Item("终端版本", com.lora.cn.utils.LoRaFrameParser.normalizeFirmwareVersionString(frame.firmwareVersionString)));
