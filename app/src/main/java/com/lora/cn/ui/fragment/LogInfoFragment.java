...
public class LogInfoFragment extends Fragment {
    ...
    private void initLogData() {
        ...
        logList.add(new TerminalLog("2024-01-15 09:28:15", "异常", "终端002", "T002", "李四", "2024-01-15 09:40:30", "处理异常"));
        logList.add(new TerminalLog("2024-01-15 09:25:10", "离线", "终端003", "T003", "", "", "重新连接"));
        logList.add(new TerminalLog("2024-01-15 09:20:45", "低电量", "终端004", "T004", "王五", "2024-01-15 09:25:20", "更换电池"));
        ...
        logList.add(new TerminalLog("2024-01-15 09:05:15", "在线", "终端010", "T010", "周八", "2024-01-15 09:15:30", "状态检查"));
