 ...
 * 分组列表适配器
 */
public class GroupAdapter extends BaseQuickAdapter<Group, QuickViewHolder> {
    @Override
    protected void onBindViewHolder(@NonNull QuickViewHolder holder, int i, @Nullable Group group) {
